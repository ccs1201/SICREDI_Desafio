...
public interface MapperInterface<RESPONSEMODEL, INPUTMODEL, ENTITY> {
     ...
     * @return {@code ENTITY} Uma nova Entidade.
     */
    ...
    /**
     * <p><b>Converte uma coleção de {@code ENTITY} em {@code RESPONSEMODEL} que representam
     * entidades de domínio</b></p>
     *
     * @param collection A coleção a ser convertida.
     * @return {@link Collection<RESPONSEMODEL>} A coleção convertida.
     */
